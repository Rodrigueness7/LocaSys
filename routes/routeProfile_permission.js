...
routeProfile_permission.put('/updateProfile_permission', verifyToken, checkAcess('profile_permission'), controller.update)
routeProfile_permission.delete('/deleteProfile_permission/:idProfile', verifyToken, checkAcess('profile_permission'), controller.remover)
